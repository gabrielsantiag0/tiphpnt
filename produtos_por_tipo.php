...
$idTipo = $_GET['id_tipo'];
$listaPorTipo = $conn->query("select * from vw_tbptodutos where id_tipo_produto = $idTipo");
...
<?php if ($numRows == 0){?>
    <h2 class="breadcrumb alert-danger">
        <a href="javascript:window.history.go(-1)" class="btn btn-danger"><span class="glyphicon glyphicon-chevron-left"></span></a>
        ...
        <?php do{?>
            <div class="col-sm-6 col-md-4">
                <div class="thumbail">
                    ...
                    <img src="imges/<?php echo $rowPorTipo['imagem_produto']?>" class="img-responsive img-rounded">
                    </a>
                    <div class="caption text-right">
                        ...
                        <p>
                            ...
                            <?php  echo "R$".number_format($rowPorTipo['valor_produto'])?>
                            </button>
                            <a href="produto_detalhes.php?id_produto=<?php echo $rowPorTipo['id_produto']?>">
