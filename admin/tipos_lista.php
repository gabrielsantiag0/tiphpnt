...
<?php include "menu_adm.php"; ?>
   ...
   <h2 class="breadcrumb alert-danger">Lista Tipos</h2>
   <table class="table table-hover table-condensed tb-opacidade bg-danger"> 
       ...
       <tbody>
        ...
        <?php do{  ?>
            ...
            <td>
            <a href="tipos_insere.php?id_produto=<?php echo $row['id_tipo'];?>" role="button" class="btn btn-warning btn-block btn-xs">
