...
if($_POST){ //
    if(($_FILES)['imagem_produto']['name']){
        ...
        $tpm_img = $_FILES['imagem_produto']['_tpmname'];
    ...
    $id = $_POST['id_produto'];
    $updateSql = "uptade tbprodutos
                    set id_tipo_produtos = '$id_tipo_produto',
...
$lista = $conn -> query("select * from tbprodutos where id_produto = $id_form");$row = $lista->fetch_assoc();
                ...
                <div class="col-xs-12 col-sm-offset-2 col-sm-6 col-md-8">
                    ...
                    <div class="thumbnail">
                        <div class="alert alert-danger" role="alert">
                            <form action="produto_atualiza.php" method="post" name="form_produto_insere" enctype="multipart/form-data" id="form_produto_insere">

                            <input type="hidden" name="id_produto" id="id_produto" value="<?php echo $row_fk['id_produto']; ?>">
