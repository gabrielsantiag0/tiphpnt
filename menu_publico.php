 ...
 <nav class="fixed navbar fixed-top navbar-light navbar-inverse bg-light">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a href="index.php" class="navbar-brand"> <img src="images/logo - Copia.png" alt="logotipo da churrascaria"></a>
        </div>
        ...
        <!-- nav direita -->
            <div class="collapse navbar-collapse" id="menupublico">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="admin/index.php">
                        <span class="span.glyphicon-user">&nbsp;ADMIN/CLIENTE</span>
                    </a> </li>
                </ul>
            </div>
    </div>
